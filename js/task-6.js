...
const selectBtnCreate = document.querySelector("button[data-create]");
const selectBtn = document.querySelector("button[data-destroy]");

selectBtnCreate.addEventListener("click", createBoxes);
...
selectBtn.addEventListener("click", destroyBoxes);
